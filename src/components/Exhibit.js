      ...
      <div className="bg-neutral-300  p-12 ">
        <section className="grid gap-8 md:grid-cols-2 md:items-center p-4">
          ...
          <div class="text-block mt-20 ml-80  mr-60 p-10 h-96">
            <h4 className="text-4xl p-5 text-[#f59e0b]"> Why Exhibit?</h4>
        ...
        <div className="bg-neutral-300 ">
          ...
          <p className="text-justify text-gray-500 dark:text-gray-400 text-2xl p-3 mx-20">
        ...
        <div class="container">
          ...
          />
          <div class="text-block h-80 p-20 ml-6" id="p3">
